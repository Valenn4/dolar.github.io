...
function api() {
    ...
    .then(data => data.json())
    .then(data => {
        oficial.innerHTML = `${data[0].casa.nombre} <br> Compra: ${data[0].casa.compra} Venta: ${data[0].casa.compra}`

        blue.innerHTML = `${data[1].casa.nombre} <br> Compra: ${data[1].casa.compra} Venta: ${data[1].casa.compra}`

        contado.innerHTML = `${data[3].casa.nombre} <br> Compra: ${data[3].casa.compra} Venta: ${data[3].casa.compra}`
    })  
